GTFS_URLS = {
    ...
    "NY_Waterway": "https://nywaterway.connexionz.net/rtt/public/utility/gtfsrealtime.aspx/tripupdate",
}
...
GTFS_METADATA = {
    ...
    "NY_Waterway": "https://nywaterway.connexionz.net/rtt/public/resource/gtfs.zip",
}
